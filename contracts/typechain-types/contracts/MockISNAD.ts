...
export interface MockISNADInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface MockISNAD extends BaseContract {
  connect(runner?: ContractRunner | null): MockISNAD;
  waitForDeployment(): Promise<this>;

  interface: MockISNADInterface;
