...
export interface ISNADTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BURNER_ROLE"
      | "CLOCK_MODE"
...
export interface ISNADToken extends BaseContract {
  connect(runner?: ContractRunner | null): ISNADToken;
  waitForDeployment(): Promise<this>;

  interface: ISNADTokenInterface;
