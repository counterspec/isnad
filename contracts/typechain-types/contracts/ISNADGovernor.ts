...
export interface ISNADGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface ISNADGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): ISNADGovernor;
  waitForDeployment(): Promise<this>;

  interface: ISNADGovernorInterface;
