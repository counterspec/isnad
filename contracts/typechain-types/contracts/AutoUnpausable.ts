...
export interface AutoUnpausableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MAX_PAUSE_DURATION"
...
export interface AutoUnpausable extends BaseContract {
  connect(runner?: ContractRunner | null): AutoUnpausable;
  waitForDeployment(): Promise<this>;

  interface: AutoUnpausableInterface;
