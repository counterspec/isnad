...
export interface ISNADStakingV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "BURN_ADDRESS"
      | "DEFAULT_ADMIN_ROLE"
...
export interface ISNADStakingV2 extends BaseContract {
  connect(runner?: ContractRunner | null): ISNADStakingV2;
  waitForDeployment(): Promise<this>;

  interface: ISNADStakingV2Interface;
